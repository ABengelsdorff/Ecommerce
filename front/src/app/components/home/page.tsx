...
const Home = () => {
    ...
    return (
        <div className="m-4 min-h-screen flex flex-col items-center justify-center">
          ...
          <h1 className="font-serif text-center font-bold text-5xl m-6 text-black drop-shadow-lg">INNOVA</h1>
          <h2 className="font-serif text-center font-bold text-5xl m-4 text-black drop-shadow-lg">
